...
class bacteria():
    ...
    def tumboNado(self, numGaps):
        ...
        # Verificar el estado de matrixCopy después de insertar gaps
        #print("Después de insertar gaps:", matrixCopy)
        
        # Aplicar TumboNado2 a cada secuencia
        for secuencia in range(len(matrixCopy)):
            matrixCopy[secuencia] = mm.TumboNado2(list(matrixCopy[secuencia]))
        
        matrixCopy = ["".join(seq) for seq in matrixCopy]
        # Verificar el estado de matrixCopy después de aplicar TumboNado2
        #print("Después de aplicar TumboNado2:", matrixCopy)
